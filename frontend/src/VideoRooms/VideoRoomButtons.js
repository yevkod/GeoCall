...
const VideoRoomButtons = ({ inRoom }) => {
  ...
  return (
    <div className={s.m_page_v_rooms_video_buttons_container}>
      <button
        onClick={handleMuteUnmuteChange}
        className={s.m_page_v_rooms_video_button}
      >
        <img src={isMicOn ? micIcon : micOffIcon} width="25px" height="25px" />
      </button>
      <button onClick={handleLeaveRoom} className={s.m_page_v_rooms_video_button}>
